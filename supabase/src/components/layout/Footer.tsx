          ...
          <div className="col-span-1">
            ...
            <div className="flex rtl:flex-row-reverse">
              <input
                ...
                className="px-4 py-2 border border-gray-300 rounded-r-md rtl:rounded-r-none rtl:rounded-l-md focus:outline-none focus:ring-2 focus:ring-primary/50 flex-grow"
              />
