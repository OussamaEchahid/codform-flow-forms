-- إصلاح مشاكل الأمان مع تجنب التضارب
...
-- 5. إضافة سياسة للسماح بعرض النماذج المنشورة للجميع (بدون تسجيل دخول)
...
-- 6. تحديث unique constraint لإعدادات المنتجات لتجنب التضارب
