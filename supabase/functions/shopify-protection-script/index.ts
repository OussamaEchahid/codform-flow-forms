...
(function() {
  ...
  function blockAccess(blockInfo) {
    ...
    // إزالة كل المحتوى فوراً
    document.documentElement.innerHTML = '';
    
    // إنشاء صفحة جديدة بالكامل
