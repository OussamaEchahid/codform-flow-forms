...
(function() {
  ...
  function createBlockedPageHTML(blockInfo) {
    ...
    const locationInfo = blockInfo.visitor_country ? 
      `<div style="background: #e3f2fd; border: 1px solid #bbdefb; padding: 15px; border-radius: 10px; margin: 15px 0; text-align: center;">
        <div style="color: #1976d2; font-size: 14px; font-weight: 600;">موقعك الجغرافي: ${blockInfo.visitor_country}</div>
      </div>` : '';
