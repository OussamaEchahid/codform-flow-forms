  ...
  return (
    <TooltipProvider>
      <div className="container mx-auto py-6 max-w-4xl">
        ...
        <Accordion type="multiple" defaultValue={["orders", "general", "spam"]} className="space-y-4">
          {/* قسم إعدادات الطلب */}
          <AccordionItem value="orders" className="border rounded-lg bg-card">
            <AccordionTrigger className="px-6 py-4 hover:no-underline">
              <div className="flex items-center gap-3">
                <Users className="h-5 w-5 text-primary" />
                <span className="text-lg font-medium">Order settings</span>
              </div>
            </AccordionTrigger>
          ...
          {/* قسم حظر السبام */}
          <AccordionItem value="spam" className="border rounded-lg bg-card">
            <AccordionTrigger className="px-6 py-4 hover:no-underline">
              <div className="flex items-center gap-3">
                <Shield className="h-5 w-5 text-primary" />
                <span className="text-lg font-medium">Block spam</span>
              </div>
            </AccordionTrigger>
            <AccordionContent className="px-6 pb-6">
              <div className="space-y-6">
          ...
          {/* قسم الخطط */}
          <AccordionItem value="plans" className="border rounded-lg bg-card">
            <AccordionTrigger className="px-6 py-4 hover:no-underline">
              <div className="flex items-center gap-3">
