...
const translations = {
  en: {
    ...
    step1AddIPs: 'Step 1: Add blocked IP addresses or countries below',
    step2GenerateScript: 'Step 2: Click the button to generate protection script',
    step3CopyScript: 'Step 3: Copy the script and paste it in Shopify theme',
    resultBlockVisitors: 'Result: Visitors will be blocked immediately when entering the store',
  ...
  ar: {
    ...
    step1AddIPs: 'الخطوة 1: أضف عناوين IP أو الدول المحظورة أدناه',
    step2GenerateScript: 'الخطوة 2: اضغط على الزر لإنتاج سكريپت الحماية',
    step3CopyScript: 'الخطوة 3: انسخ السكريپت والصقه في ثيم شوبيفاي',
    resultBlockVisitors: 'النتيجة: سيتم حظر الزوار فوراً عند دخولهم للمتجر',
