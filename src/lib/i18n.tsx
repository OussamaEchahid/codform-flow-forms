...
const translations = {
  en: {
    ...
    manageLinkedProducts: 'Manage Linked Products',
    manageProductsForForm: 'Manage products linked to form',
    loadingProductsModal: 'Loading products...',
    totalProducts: 'Total products',
    linkedProductsCount: 'Linked',
    linkProduct: 'Link',
    unlinkProduct: 'Unlink',
    productLinkedSuccessfully: 'Product linked to form successfully',
    productUnlinkedSuccessfully: 'Product unlinked from form successfully',
    failedToLinkProduct: 'Failed to link product to form',
    failedToUnlinkProduct: 'Failed to unlink product from form',
  ...
  ar: {
    ...
    // Product Management Modal
    manageLinkedProducts: 'إدارة المنتجات المرتبطة',
    manageProductsForForm: 'إدارة المنتجات المرتبطة بالنموذج',
    loadingProductsModal: 'جاري تحميل المنتجات...',
    totalProducts: 'إجمالي المنتجات',
    linkedProductsCount: 'المرتبطة',
    linkProduct: 'ربط',
    unlinkProduct: 'إلغاء الربط',
    productLinkedSuccessfully: 'تم ربط المنتج بالنموذج بنجاح',
    productUnlinkedSuccessfully: 'تم إلغاء ربط المنتج من النموذج بنجاح',
    failedToLinkProduct: 'فشل في ربط المنتج بالنموذج',
    failedToUnlinkProduct: 'فشل في إلغاء ربط المنتج من النموذج',
    storeIdNotFound: 'لم يتم العثور على معرف المتجر',
