      ...
      <Card className="mb-4 border-2 border-primary/20 bg-gradient-to-r from-primary/5 to-primary/10">
        ...
        <div className="mt-8 pt-6 border-t">
          ...
          <div className="space-y-2 mb-6">
            <Label className="text-sm font-medium">Enable popup button</Label>
            <div className="flex items-center gap-2">
              <Switch
                checked={formStyle.popupButton?.enabled || false}
                onCheckedChange={(checked) => onStyleChange('popupButton', {
                  ...(formStyle.popupButton || {}),
                  enabled: checked,
                  text: formStyle.popupButton?.text || 'Buy with Cash on Delivery',
                  backgroundColor: formStyle.popupButton?.backgroundColor || '#9b87f5',
                  textColor: formStyle.popupButton?.textColor || '#ffffff',
                  borderColor: formStyle.popupButton?.borderColor || '#9b87f5',
                  borderRadius: formStyle.popupButton?.borderRadius || '8px',
              ...
              />
              <span className="text-sm text-muted-foreground">
                {formStyle.popupButton?.enabled ? 'Enabled' : 'Disabled'}
              </span>
            </div>
          </div>
          ...
          {formStyle.popupButton?.enabled && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pl-4 border-l-2 border-primary/20">
              <div className="space-y-2">
                ...
                <Input
                  type="text"
                  value={formStyle.popupButton?.text || 'Buy with Cash on Delivery'}
                  onChange={(e) => onStyleChange('popupButton', {
                    ...formStyle.popupButton,
                    text: e.target.value
                  })}
              ...
              <div className="space-y-2">
                <Label className="flex items-center justify-between text-sm font-medium">
                  <span>Font size ({getNumericValue(formStyle.popupButton?.fontSize, 16)})</span>
                  <span className="text-xs text-muted-foreground">24</span>
                </Label>
                <Slider
                  value={[getNumericValue(formStyle.popupButton?.fontSize, 16)]}
                  onValueChange={(value) => onStyleChange('popupButton', {
                    ...formStyle.popupButton,
                    fontSize: formatWithPx(value[0])
                  })}
                  min={12}
                  max={24}
                  step={1}
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={formStyle.popupButton?.fontWeight || '600'}
                  onValueChange={(value) => onStyleChange('popupButton', {
                    ...formStyle.popupButton,
                    fontWeight: value
                  })}
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <Input
                    type="color"
                    value={formStyle.popupButton?.textColor || '#ffffff'}
                    onChange={(e) => onStyleChange('popupButton', {
                      ...formStyle.popupButton,
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <Input
                    type="color"
                    value={formStyle.popupButton?.backgroundColor || '#9b87f5'}
                    onChange={(e) => onStyleChange('popupButton', {
                      ...formStyle.popupButton,
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <Input
                    type="color"
                    value={formStyle.popupButton?.borderColor || '#9b87f5'}
                    onChange={(e) => onStyleChange('popupButton', {
                      ...formStyle.popupButton,
              ...
              <div className="space-y-2">
                <Label className="flex items-center justify-between text-sm font-medium">
                  <span>Border width ({getNumericValue(formStyle.popupButton?.borderWidth, 2)})</span>
                  <span className="text-xs text-muted-foreground">5</span>
                </Label>
                <Slider
                  value={[getNumericValue(formStyle.popupButton?.borderWidth, 2)]}
                  onValueChange={(value) => onStyleChange('popupButton', {
                    ...formStyle.popupButton,
                    borderWidth: formatWithPx(value[0])
                  })}
                  max={5}
                  step={1}
                  className="w-full"
              ...
              <div className="space-y-2">
                <Label className="flex items-center justify-between text-sm font-medium">
                  <span>Border radius ({getNumericValue(formStyle.popupButton?.borderRadius, 8)})</span>
                  <span className="text-xs text-muted-foreground">50</span>
                </Label>
                <Slider
                  value={[getNumericValue(formStyle.popupButton?.borderRadius, 8)]}
                  onValueChange={(value) => onStyleChange('popupButton', {
                    ...formStyle.popupButton,
                    borderRadius: formatWithPx(value[0])
                  })}
                  max={50}
                  step={1}
                  className="w-full"
              ...
              <div className="space-y-2">
                <Label className="flex items-center justify-between text-sm font-medium">
                  <span>Padding Y ({getNumericValue(formStyle.popupButton?.paddingY, 12)})</span>
                  <span className="text-xs text-muted-foreground">20</span>
                </Label>
                <Slider
                  value={[getNumericValue(formStyle.popupButton?.paddingY, 12)]}
                  onValueChange={(value) => onStyleChange('popupButton', {
                    ...formStyle.popupButton,
                    paddingY: formatWithPx(value[0])
                  })}
                  min={4}
                  max={20}
                  step={1}
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={formStyle.popupButton?.animation || 'none'}
                  onValueChange={(value) => onStyleChange('popupButton', {
                    ...formStyle.popupButton,
                    animation: value
                  })}
              ...
              <div className="space-y-2">
                ...
                <div className="flex items-center gap-2">
                  <Switch
                    checked={formStyle.popupButton?.showIcon || false}
                    onCheckedChange={(checked) => onStyleChange('popupButton', {
                      ...formStyle.popupButton,
                      showIcon: checked
                    })}
                  />
                  <span className="text-sm text-muted-foreground">
                    {formStyle.popupButton?.showIcon ? 'Yes' : 'No'}
                  </span>
                </div>
              </div>
            </div>
