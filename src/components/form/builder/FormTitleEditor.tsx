...
import { AlignLeft, AlignCenter, AlignRight, Bold, Type, Palette } from 'lucide-react';
...
const FormTitleEditor: React.FC<FormTitleEditorProps> = ({
  ...
  const handleUpdateLabel = (value: string) => {
    ...
    onUpdateTitleField(updatedField);
    onFormTitleChange(value); // Also update form title
  };
  ...
  const handleUpdateDescription = (value: string) => {
    ...
    onUpdateTitleField(updatedField);
    onFormDescriptionChange(value); // Also update form description
  };
