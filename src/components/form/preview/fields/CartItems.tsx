...
const CartItems: React.FC<CartItemsProps> = ({
  ...
  return <div className="mb-6 codform-cart-items">
      {showTitle && <h3 className="text-lg font-medium mb-3" style={{
      ...
      direction: language === 'ar' ? 'rtl' : 'ltr'
        ...
        <div className="flex items-center p-4 border-b codform-cart-item" data-product-item>
          <div className="w-20 h-20 bg-gray-100 rounded-md flex-shrink-0 ml-4 flex items-center justify-center" style={{
          borderRadius: '0.25rem'
        }}>
            <img alt="Product" className="w-full h-full object-cover product-image" style={{
            borderRadius: '0.25rem'
          }} onError={e => {
          ...
          }} src="/lovable-uploads/d5e88467-d848-4f8d-83c4-9c81427065db.png" />
          </div>
