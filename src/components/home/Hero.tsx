...
const Hero = () => {
  ...
  const t = {
    ...
    subtitle: language === 'ar' ? 'منصة متكاملة لإنشاء نماذج مخصصة للدفع عند الاستلام تتكامل مع متاجر Shopify بكل سهولة' : 'An all‑in‑one platform to build custom COD forms that integrate seamlessly with Shopify.',
