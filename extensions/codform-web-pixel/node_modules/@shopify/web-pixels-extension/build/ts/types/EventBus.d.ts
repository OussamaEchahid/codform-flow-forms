...
export type PublisherData<P> = P extends {
    data: infer T;
} ? T : never;
export type PublisherCustomData<P> = P extends {
    customData: infer T;
} ? T : never;
...
export interface EventBus {
    publish<K extends KeyOfEvent<PixelEvents>>(name: K, payload: PublisherData<PixelEvents[K]>, options?: PublisherOptions): boolean;
    publishCustomEvent(name: string, payload?: PublisherCustomData<CustomEvent>, options?: PublisherOptions): boolean;
    subscribe<K extends KeyOfEvent<Events>>(name: K, callback: SubscriberCallback<Events[K]>, options?: SubscriberOptions): () => boolean;
}
